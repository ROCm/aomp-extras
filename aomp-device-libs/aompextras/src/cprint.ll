...
entry:
  ...
  tail call void @llvm.memcpy.p1i8.p4i8.i64(i8 addrspace(1)* align 1 dereferenceable(7) %27, i8 addrspace(4)* align 1 dereferenceable(7) getelementptr inbounds ([7 x i8], [7 x i8] addrspace(4)* @.str.1, i64 0, i64 0), i64 7, i1 false)
...
entry:
  %0 = load float, float* %f, align 4, !tbaa !8
  ...
  %27 = addrspacecast i8* %26 to i8 addrspace(1)*
  tail call void @llvm.memcpy.p1i8.p4i8.i64(i8 addrspace(1)* align 1 dereferenceable(7) %27, i8 addrspace(4)* align 1 dereferenceable(7) getelementptr inbounds ([7 x i8], [7 x i8] addrspace(4)* @.str.2, i64 0, i64 0), i64 7, i1 false)
...
entry:
  ...
  %2 = tail call i32 @__strlen_max(i8* %s, i32 1024) #2
  %total_buffer_size = add i32 %2, 47
  %3 = tail call i8* @printf_allocate(i32 %total_buffer_size) #2
  %4 = bitcast i8* %3 to i32*
  %5 = addrspacecast i32* %4 to i32 addrspace(1)*
  store i32 40, i32 addrspace(1)* %5, align 4
  %6 = getelementptr inbounds i8, i8* %3, i64 4
  %7 = bitcast i8* %6 to i32*
  %8 = addrspacecast i32* %7 to i32 addrspace(1)*
  store i32 3, i32 addrspace(1)* %8, align 4
  %9 = getelementptr inbounds i8, i8* %3, i64 8
  %10 = bitcast i8* %9 to i32*
  %11 = addrspacecast i32* %10 to i32 addrspace(1)*
  store i32 983041, i32 addrspace(1)* %11, align 4
  %12 = getelementptr inbounds i8, i8* %3, i64 12
  %13 = bitcast i8* %12 to i32*
  %14 = addrspacecast i32* %13 to i32 addrspace(1)*
  store i32 983041, i32 addrspace(1)* %14, align 4
  %15 = getelementptr inbounds i8, i8* %3, i64 16
  %16 = bitcast i8* %15 to i32*
  %17 = addrspacecast i32* %16 to i32 addrspace(1)*
  store i32 196672, i32 addrspace(1)* %17, align 4
  %18 = getelementptr inbounds i8, i8* %3, i64 20
  %19 = bitcast i8* %18 to i32*
  %20 = addrspacecast i32* %19 to i32 addrspace(1)*
  store i32 7, i32 addrspace(1)* %20, align 4
  %21 = getelementptr inbounds i8, i8* %3, i64 24
  %22 = bitcast i8* %21 to i32*
  %23 = addrspacecast i32* %22 to i32 addrspace(1)*
  store i32 %2, i32 addrspace(1)* %23, align 4
  %24 = getelementptr inbounds i8, i8* %3, i64 32
  %25 = bitcast i8* %24 to i64*
  %26 = addrspacecast i64* %25 to i64 addrspace(1)*
  store i64 %1, i64 addrspace(1)* %26, align 8
  %27 = getelementptr inbounds i8, i8* %3, i64 40
  %28 = addrspacecast i8* %27 to i8 addrspace(1)*
  tail call void @llvm.memcpy.p1i8.p4i8.i64(i8 addrspace(1)* align 1 dereferenceable(7) %28, i8 addrspace(4)* align 1 dereferenceable(7) getelementptr inbounds ([7 x i8], [7 x i8] addrspace(4)* @.str.3, i64 0, i64 0), i64 7, i1 false)
  %29 = getelementptr inbounds i8, i8* %3, i64 47
  %30 = addrspacecast i8* %29 to i8 addrspace(1)*
  tail call void @llvm.memcpy.p1i8.p0i8.i32(i8 addrspace(1)* align 1 %30, i8* align 1 %s, i32 %2, i1 false)
  %31 = tail call i32 @printf_execute(i8* %3, i32 %total_buffer_size) #2
  ret void
}
...
!2 = !{i32 2, i32 0}
!3 = !{!"AOMP_STANDALONE_13.0-2 clang version 13.0.0 (https://github.com/ROCm-Developer-Tools/llvm-project 897d9549eb6dfdf42ee44e6371107b9ae2df7129)"}
!4 = !{!5, !5, i64 0}
!5 = !{!"int", !6, i64 0}
